...
namespace garderie.app2.Server.Migrations
{
    ...
    [Migration("20250922172525_AddAnswers")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("garderie.app2.Server.Models.Entities.Answer", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("garderie.app2.Server.Models.Entities.Answer", b =>
                {
                    b.HasOne("garderie.app2.Server.Models.Entities.Kid", null)
                        .WithMany("Answers")
                        .HasForeignKey("kidId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
